package de.tuhh.luethke.projection;
...
public class ObliqueMercator implements MapProjection
{
    ...
    public ObliqueMercator(Ellipsoid ellipsoid)
    {
      ...
      /*  this.ellipsoid = new Ellipsoid(Ellipsoid.BESSEL_1841);
        ...
        /*this.ellipsoid = new Ellipsoid(Ellipsoid.WGS_84);
        //Hamburg as center:
        lc = 53.54000*DEG2RAD;
        fc = 9.980000*DEG2RAD;
        ac = 90*DEG2RAD;
     ...
     // Custom parameters for PrePos
        ...
        lc = 37.61569*DEG2RAD;
        fc = -122.38797*DEG2RAD;
        ac = 178.07111*DEG2RAD;
        gc = 178.07111*DEG2RAD;                          // Assume rectified bearing same as centre line bearing.
        kc = 1;
        FE = 0;
        FN = 0;
