...
public class Test {
	...
	public static void main(String[] args) {
		LinkedList<Measurement> measurements = CabDataParser.parse("new_uvjeahot_tst.txt");//LatitudeHistoryParser.parse("jonas.kml");
		...
		List<SimpleMatrix> posVectors = PositionalTSTransformer.transformTSData(
		  measurements, 3);
...
//		double[][] mean3 = { { 0 }, { 2 }, { 0 }, { 3 } };
		...
		meansA.add(Preprocessor.projectData6(new SimpleMatrix(mean1)));
		meansA.add(Preprocessor.projectData6(new SimpleMatrix(mean2)));
		meansA.add(Preprocessor.projectData6(new SimpleMatrix(mean3)));
		try {
		...
		double[][] z1;
		z1 = calculateY1(x, y, 37.615319,-122.387062, 37.684907,-122.390469 , dist, weightedCoordinates, false);
	...
	public static double[][] calculateY1(double[] x, double[] y, double setX, double setY, double setX1, double setY1, BaseSampleDistribution dist, ArrayList<SimpleMatrix> weightedCoordinates, boolean swap) {
