...
public class PredictionWorker implements Callable<Double> {
	...
	public PredictionWorker(Measurement[] mMeasurements, SampleModel mModel, int searchRadius,
			int searchSegmentDistance, int accuracyRadius, int predictionSegments, int UTMZoneNo, char UTMZoneLetter) {
		super();
